...
namespace Client
{
    class ClientUser
    {
        public delegate void ClientReceivedHandler(ClientUser sender, byte[] data);
        public delegate void ClientDisconnectedHandler(ClientUser sender);
        ...
        public ClientUser(Socket accepted)
        {
            _socket = accepted;
